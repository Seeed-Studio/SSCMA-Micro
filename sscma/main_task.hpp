...
void run() {
    ...
    // register commands
    {
        static_resource->instance->register_cmd(
          "HELP?", "List available commands", "", [](std::vector<std::string> argv) {
        ...
        static_resource->instance->register_cmd(
          "BREAK", "Stop all running tasks", "", [](std::vector<std::string> argv) {
        ...
        static_resource->instance->register_cmd(
          "MODELS?", "Get available models", "", [](std::vector<std::string> argv) {
        ...
        static_resource->instance->register_cmd(
          "MODEL?", "Get current model info", "", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
        ...
        static_resource->instance->register_cmd(
          "SENSORS?", "Get available sensors", "", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
        ...
        static_resource->instance->register_cmd(
          "SAMPLE?", "Get sample task status", "", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
        ...
        static_resource->instance->register_cmd(
          "ACTION", "Set action trigger", "\"EXPRESSION\"", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
                [argv = std::move(argv)](const std::atomic<bool>&) { set_action(argv); });
              return EL_OK;
          });
        ...
        static_resource->instance->register_cmd(
          "INFO", "Store info string to device flash", "\"INFO_STRING\"", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
                [argv = std::move(argv)](const std::atomic<bool>&) { set_info(argv); });
              return EL_OK;
          });
        ...
        static_resource->instance->register_cmd(
          "INFO?", "Get info string from device flash", "", [](std::vector<std::string> argv) {
              static_resource->executor->add_task(
                [cmd = std::move(argv[0])](const std::atomic<bool>&) { get_info(cmd); });
              return EL_OK;
          });
