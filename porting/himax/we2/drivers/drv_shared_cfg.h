...
#define SERIAL1_TRANSPORT_RX_BASE_SIZE (6 * 1024)
    ...
    #define WIRE_TRANSPORT_TX_BASE_SIZE (36 * 1024)
    #define WIRE_TRANSPORT_RX_BASE_ADDR ALIGN_32BIT(WIRE_TRANSPORT_TX_BASE_ADDR + WIRE_TRANSPORT_TX_BASE_SIZE)
    #define WIRE_TRANSPORT_RX_BASE_SIZE (6 * 1024)
#else
    #define WIRE_TRANSPORT_TX_BASE_ADDR ALIGN_32BIT(SERIAL2_TRANSPORT_RX_BASE_ADDR + SERIAL2_TRANSPORT_RX_BASE_SIZE)
    #define WIRE_TRANSPORT_TX_BASE_SIZE 0
    #define WIRE_TRANSPORT_RX_BASE_ADDR ALIGN_32BIT(WIRE_TRANSPORT_TX_BASE_ADDR + WIRE_TRANSPORT_TX_BASE_SIZE)
    #define WIRE_TRANSPORT_RX_BASE_SIZE 0
#endif
...
#else
    #define MA_CONTENT_EXPORT_CACHE_SIZE (36 * 1024)
    #define SRAM_2_START_ADDR_FREE \
        (WIRE_TRANSPORT_TX_BASE_ADDR + WIRE_TRANSPORT_TX_BASE_SIZE + MA_CONTENT_EXPORT_CACHE_SIZE)
    #define SRAM_2_SIZE_FREE             (SRAM_2_SIZE - (SRAM_2_START_ADDR_FREE - SRAM_2_START_ADDR))
    #define MA_CONTENT_EXPORT_CACHE_ADDR (uint8_t*)(WIRE_TRANSPORT_TX_BASE_ADDR + WIRE_TRANSPORT_TX_BASE_SIZE)
#endif

static_assert(SRAM_2_SIZE_FREE >= 48 * 1024, "SRAM2 is not enough");
