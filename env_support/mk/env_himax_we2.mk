...
LIB_SSCMA_MICRO_DEFINES = -DLIB_SSCMA_MICRO -DHIMAX_PLATFORM -DSSCMA_OSAL_FREERTOS -DSSCMA_BOARD_GROVE_VISION_AI_WE2=1 -DSSCMA_FILESYSTEM_LITTLEFS=1

LIB_SSCMA_MICRO_DIR = $(LIBRARIES_ROOT)/sscma_micro

LIB_SSCMA_MICRO_3RDPARTY_DIR = $(LIB_SSCMA_MICRO_DIR)/third_party

LIB_SSCMA_MICRO_3RDPARTY_LFS_DIR = $(LIB_SSCMA_MICRO_3RDPARTY_DIR)/littlefs/littlefs
LIB_SSCMA_MICRO_3RDPARTY_LFS_SRCS_DIR = $(LIB_SSCMA_MICRO_3RDPARTY_LFS_DIR)

LIB_SSCMA_MICRO_3RDPARTY_INCS_DIR = $(LIB_SSCMA_MICRO_3RDPARTY_LFS_SRCS_DIR)
LIB_SSCMA_MICRO_3RDPARTY_SRCS_DIR += $(LIB_SSCMA_MICRO_3RDPARTY_LFS_SRCS_DIR)
...
LIB_SSCMA_MICRO_OBJS = $(LIB_SSCMA_MICRO_ASMOBJS) $(LIB_SSCMA_MICRO_COBJS) $(LIB_SSCMA_MICRO_CXXOBJS)
